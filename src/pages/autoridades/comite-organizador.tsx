...
export default function ComiteOrganizadorPage({ comite, comisionPageData, globalSEO, logoUrl }: Props) {
    ...
    const backgroundImage = comisionPageData?.featured_image?.formats?.large?.url 
        ? `${URL_DOMAIN}${comisionPageData.featured_image.formats.large.url}`
        : comisionPageData?.featured_image?.url 
        ? `${URL_DOMAIN}${comisionPageData.featured_image.url}`
        : "/bg-default-blue.png";
                    ...
                    <div className="container max-w-[1280px] mx-auto px-4">
                        {comite.length > 0 ? (
                            ...
                            <div className="text-center py-20">
                                ...
                                <p className="text-gray-500">La información del Comité Organizador se publicará próximamente.</p>
                            </div>
                        )}
                    </div>
                </section>
