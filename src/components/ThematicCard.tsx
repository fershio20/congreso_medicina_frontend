    ...
    return (
        <>
            ...
            <div
                ...
                {description &&(
                <div
                    className="opacity-0 max-h-0 overflow-hidden transition-all  ease-in-out duration-300 group-hover:opacity-100 group-hover:max-h-[1000px] absolute top-0 left-0 w-full h-full bg-white p-5 rounded-lg"
